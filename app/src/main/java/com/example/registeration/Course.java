...
public class Course {
    ...
    String courseColleage;//학부 혹은 대학원
    ...
    public String getCourseColleage() {
        return courseColleage;
    }

    public void setCourseUniversity(String courseColleage) {
        this.courseColleage = courseColleage;
    }
    ...
    public Course(int courseID, String courseColleage, int courseYear, String courseTerm, String courseArea, String courseMajor, String courseGrade, String courseTitle, int courseCredit, int courseDivide, int coursePersonnel, String courseProfessor, String courseTime, String courseRoom) {
        this.courseID = courseID;
        this.courseColleage = courseColleage;
        this.courseYear = courseYear;
        this.courseTerm = courseTerm;
